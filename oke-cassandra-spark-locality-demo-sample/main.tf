...
module "oke" {
  ...
  lb_subnet_id                                                                = module.network.edge_id
  ...
  endpoint_subnet_id                                                          = var.cluster_endpoint_config_is_public_ip_enabled ? module.network.edge_id : module.network.private_id
