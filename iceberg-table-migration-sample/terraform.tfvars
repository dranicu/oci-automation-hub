...
instance_params = {
  itvm = {
    ...
    fd                 = 1
    image_version      = "oel9"
    ssh_private_key    = ".." ## PATH TO SSH PRIVATE KEY - CHANGE ME
    script_tf_string   = "TEST_ICEBERG_TABLES"
    ocpus              = 1
    memory_in_gbs      = 16
  }
}

ssh_public_key = "..." ## PATH TO SSH PUBLIC KEY - CHANGE ME

kms_key_ids = {}
registry    = "fra.ocir.io" ## change to registry of your choice, e.g. fra.ocir.io, iad.ocir.io, etc.

# Optional validation engines. Use ["spark", "trino"] to add Trino SQL validation at the end.
