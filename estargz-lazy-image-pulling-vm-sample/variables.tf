...
variable "estargz_image" {
  description = "Optional eStargz image reference used by the VM benchmark helper."
  type        = string
  default     = ""
}

variable "regular_image" {
  description = "Optional regular image reference used as the overlayfs benchmark baseline."
  type        = string
  default     = ""
}

variable "run_validation" {
  description = "Run the benchmark once from cloud-init when image inputs are provided."
  type        = bool
  default     = false
}
